<template>
  <b-navbar toggleable="lg" type="dark" variant="primary" class="shadow mb-2 row">
    ...
    <!-- Section 2 (Search) -->
    <b-col>
      <b-collapse class="d-flex justify-content-center" is-nav>
        <b-navbar-nav>
          <b-form-input
            class="mr-2 search"
    ...
    <!-- Section 3 (Profile) -->
    <b-col>
      <b-collapse class="d-flex justify-content-end" is-nav>
        <b-navbar-nav>
          <b-nav-item-dropdown
            name="user-profile"
            right
...
export default {
  ...
  methods: {
    ...
    searchCompound: function() {
      this.$store.dispatch("compound/fetchCompound", {searchString: this.searchString, push: true});
    }
  },
  components: {
    ChemregLogo
